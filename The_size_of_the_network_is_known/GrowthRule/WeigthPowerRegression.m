function [minD, bestFit, bestrsquare, bestrmse, bestgamma, bestmissing] = WeigthPowerRegression(N, execs)
    ...
    for ptr = 1:length(gamma)
        ...
        strsave = sprintf('GrowthRule/Candidates/RulePower/Results_%d_%d', N, gamma(ptr)*1000);
