function [minD, bestFit, bestrsquare, bestrmse, bestgamma, bestmissing] = WeigthSigmoidRegression(N, execs)
    ...
    for ptr = 1:length(gamma)
        ...
        strsave = sprintf('GrowthRule/Candidates/RuleSigmo/Results_%d_%d', N, gamma(ptr)*1000);
