function [StatisticsDCF] = simulate_PerfectInformation(span, mu1, mu2, sigma, prop1, prop2, execs)
    ...
    str = sprintf('PerfectInformation/Results_%d_%d_%d_%d_%d_%d', span, mu1, mu2, sigma, prop1, prop2);
