function [StatisticsDCF, policies] = simulate_GOALCR(span, mu1, mu2, sigma, prop1, prop2, execs)
    ...
    str = sprintf('GOAL-CR/Results_%d_%d_%d_%d_%d_%d', span, mu1, mu2, sigma, prop1, prop2);
