function [StatisticsDCF] = simulate_FixedOptimal(span, mu1, mu2, sigma, prop1, prop2, execs)
    ...
    str = sprintf('FixedOptimalProbability/Results_%d_%d_%d_%d_%d_%d', span, mu1, mu2, sigma, prop1, prop2);
