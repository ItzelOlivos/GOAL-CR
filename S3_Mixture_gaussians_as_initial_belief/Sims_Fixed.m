function [StatisticsDCF, policies] = Sims_Fixed(span, mu1, mu2, sigma, prop1, prop2, execs)
    ...
    str = sprintf('Results/Fixed/Results_%d_%d_%d_%d_%d_%d', span, mu1, mu2, sigma, prop1, prop2);
